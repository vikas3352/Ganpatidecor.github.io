 ...
 * 2. Copy ClientAudioMessage.proto under <srcroot>\pptservicescast\BroadcastService\web\MessageDefinitions to the bin folder where protoc.exe is.
 * 3. Run protoc --js_out=import_style=commonjs,binary:. ClientAudioMessage.proto to generate ClientAudioMessage_pb.js.
 * 4. Run npm install browserify and npm install google-protobuf.
 * 5. Run browserify ClientAudioMessage_pb.js -o clientAudioMessage.js
