/**
 * Steps to generation this file:
 * 1. Download Protocol Buffers Win64 version from https://github.com/protocolbuffers/protobuf/releases and extract everything. 
 * 2. Copy SpeechResponseMessage.proto under <srcroot>\pptservicescast\BroadcastService\web\MessageDefinitions to the bin folder where protoc.exe is.
 * 3. Run protoc --js_out=import_style=commonjs,binary:. SpeechResponseMessage.proto to generate SpeechResponseMessage_pb.js.
 * 4. Run npm install browserify and npm install google-protobuf.
 * 5. Run browserify SpeechResponseMessage_pb.js -o speechResponseMessage.js
 * 6. Add eslint-disable as below to suppress warnings.
 * 7. Please add this comment back to this file after generating a new copy
 */
