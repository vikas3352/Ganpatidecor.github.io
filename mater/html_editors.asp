...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_editors" target="_blank">Try it Yourself &raquo;</a>
</div>
<p><strong>Click on the &quot;Try it Yourself&quot; button to see how it works.</strong></p>
<hr>

<h2>W3Schools Spaces</h2>
<p>If you want to create your own website and save your code online, try our <strong>website builder</strong>, called <a href="/spaces/" target="_blank"><strong>W3schools Spaces</strong></a>:</p>
<div class="w3-center ws-black" style="color:white;margin-left:-32px;margin-right:-32px">
  <div style="opacity:0.96;margin:auto;padding:70px 20px;">
    <h2 style="font-family: 'Source Sans Pro', sans-serif;font-size:57px;font-weight:700;margin-bottom:25px;" class="w3-hide-small">W3Schools Spaces</h2>
    <h2 style="font-size:40px;font-weight:700;margin-bottom:25px;" class="w3-hide-large w3-hide-medium">W3Schools Spaces</h2>
    <h3 style="margin-bottom:40px;font-family: 'Source Sans Pro', sans-serif;font-size:24px">Everything you need right in the browser.</h3>
    <a href="/spaces/" target="_blank" class="ws-btn" style="border-radius:25px;font-size:20px;width:250px;padding: 11px 14px;margin-bottom:15px" title="Get Started With W3Schools Spaces">Get Started Now</a><br>
    <br>
    <img src="/how-spaces-works3.png" style="max-width:100%;margin:auto;">
  </div>
</div><br>
<br>
<div class="w3-clear nextprev">
